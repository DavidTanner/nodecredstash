  ...
  describe('#getAllVersions', () => {
    it('should fetch and decode the secrets', () => {
      ...
      AWS.mock('DynamoDB.DocumentClient', 'query', (params, cb) => {
        ...
        params.Limit.should.equal(versions);
        cb(undefined, {
          Items: [
            {
      ...
      return credentials.getAllVersions({
        ...
        allVersions[1].version.should.equal('0000000000000000005');
        allVersions[1].secret.should.equal(rawItem.plainText);
      });
    });
  });
